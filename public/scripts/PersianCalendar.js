...
//                        @Html.LabelFor(model => model.DocFlowDate, new { @class = "col-lg-4" })
//                        <div class="col-lg-7">
//                            <div class="input-group">
//                                @Html.TextBoxFor(model => model.DocFlowDate, new { @class = "col-lg-12 col-xs-12", data_prg_date = "datePicker" })
//                                @Html.ValidationMessageFor(model => model.DocFlowDate)
//                                <span class="input-group-addon" data-prg-date="datePicker">
...
//<div class="input-group">
//                                    <input class="col-lg-12 col-xs-12 valid" data-prg-date="datePicker" data-val="true" data-val-required="این فیلد اجباری می باشد" id="Date" name="Date" value="1394/07/22" type="text"> 
